...
//LIBFT test func
void    test_bzero(int n) __attribute__((weak));
void    test_isalnum(int n) __attribute__((weak));
void    test_isalpha(int n) __attribute__((weak));
void    test_isascii(int n) __attribute__((weak));
void    test_isdigit(int n) __attribute__((weak));
void    test_isprint(int n) __attribute__((weak));
void    test_memchr(int n) __attribute__((weak));
void    test_memset(int n) __attribute__((weak));
void    test_strchr(int n) __attribute__((weak));
void    test_strlen(int n) __attribute__((weak));
void    test_strncmp(int n) __attribute__((weak));
void    test_strrchr(int n) __attribute__((weak));
void    test_tolower(int n) __attribute__((weak));
void    test_toupper(int n) __attribute__((weak));
void    test_memcmp(int n) __attribute__((weak));
void    test_memcpy(int n) __attribute__((weak));
void    test_memmove(int n) __attribute__((weak));
void    test_strlcpy(int n) __attribute__((weak));
